...
chapters it needs light up, with the number of sections needed from each. For ten paths
worked out section by section, see the <a href="paths.html">reading paths</a>; for the
results themselves, the <a href="results.html">list of results</a>.
</p>
