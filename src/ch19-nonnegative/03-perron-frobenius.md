...
::: {.remark}
Alternatively, \( \rho_k \to \rho \) also follows from the continuity of eigenvalues proved in Chapter 16 §07, but that rests on a theorem about the roots of polynomials which Chapter 16 quotes without proof; the route above needs nothing of the kind.
:::
