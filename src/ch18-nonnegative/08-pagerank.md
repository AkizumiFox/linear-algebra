...
The eigenvalue bound predicts that iterates approach \( \vpi \) at a rate like \( \alpha^k \). For this particular matrix the prediction can be proved directly, with an explicit constant, by measuring errors in the \( 1 \)-norm of Chapter 15.
