...
This is the answer to Chapter 3's remark. Linear algebra describes the conserving flows as a coset of the null space of \( \N \). Linear programming chooses among them, and duality explains each choice with a certificate that can be read as a statement about the network.
