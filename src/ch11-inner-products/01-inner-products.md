...
Together, @thm-norm-properties (a), (b) and @cor-triangle-inequality say that \( \norm{\cdot} \) is a **norm** in the general sense studied in Chapter 16. Chapter 16 also shows that not every norm arises from an inner product; the last warning of this section explains how to tell.
