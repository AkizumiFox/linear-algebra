...
In dimension \( 3 \) the answer is the one physics assumes: every orientation-preserving isometry of \( \nR^3 \) is a rotation about a line. The proof is where Chapter 9 is needed, for one reason only: to produce an eigenvector.
