...
Quotients will return in Chapter 8, where an operator \( T \) with \( T(U) \subseteq U \) induces an operator on \( V/U \), and this is the engine of induction arguments on the dimension.
