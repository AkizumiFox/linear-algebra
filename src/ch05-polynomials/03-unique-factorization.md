...
\]
with \( c \) the leading coefficient, \( p_1, \dots, p_s \) **distinct** monic irreducibles over \( F \), and exponents \( e_i \ge 1 \). The monic irreducible factors of the characteristic and minimal polynomials of an operator will organize the structure theory of Chapters 8 and 9.
