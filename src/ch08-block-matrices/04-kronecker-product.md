...
The Kronecker product is the coordinate shadow of a basis-free construction: the tensor product of linear maps, in Chapter 15, whose matrix in suitable bases is exactly \( \A \otimes \B \). The dictionary order in \( (\ast) \) will reappear there as an ordering of a basis \( \v_i \otimes \w_k \).
