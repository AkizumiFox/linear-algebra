...
Once \( V = U \oplus U^{\perp} \), Chapter 3 hands us an operator: the projection onto \( U \) along \( U^{\perp} \) (@thm-projection-direct-sum). It deserves its own name and symbol, because the complement is no longer a choice.
