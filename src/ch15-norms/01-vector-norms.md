...
Chapter 10 §01 closed with a promise. It observed that @thm-norm-properties (a), (b) and @cor-triangle-inequality make every induced norm a norm in the general sense, warned that the converse fails, and named the test: the **parallelogram law**
\[
\norm{\u + \v}^2 + \norm{\u - \v}^2
= 2\norm{\u}^2 + 2\norm{\v}^2 . \tag{$\ast$}
\]
