...
% ======================================================================================
% Sixteen packages are loaded by both sleek and the book. Most take no options
...
% are sleek's link settings, handed to that one load.
\PassOptionsToPackage{pdfusetitle,linktoc=page,allcolors=blue}{hyperref}
% mdframed: sleek-theorems and latex-template both ask for framemethod=TikZ, so
